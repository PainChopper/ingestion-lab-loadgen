...
Основной маршрут — `TEACHER → Виталёс`:
...
Маршрут `TEACHER → LEAD → CODER|TESTER|VERIFIER|ANALYST` допустим только после прямого решения Виталёса делегировать реализацию, проверку или независимый анализ агентам.
...
- после результата вернись к основному маршруту `TEACHER → Виталёс` и помоги осмыслить evidence и следующий шаг.
